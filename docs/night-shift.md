...
- [x] NS-20260723-06 (S) **Night Bloom kit accents** — The petals open on swell, inhale on gather, flare on impact, and mote-glitter on hats, but kick and snare pass silently; wire kick as a radial petal pulse and snare as a lateral petal shear so drums speak through the flower. Alive. Area: `presets/NightBloom.tsx`. Accept: kick/snare/hat each produce a distinct petal accent; swell open + gather inhale + impact flare from #76 stay intact. — PR #83
