...
- [ ] NS-20260801-04 (S) **Thunderhead convergence** — Real storms organize: scattered pocket flashes consolidating into one rhythmically pulsing cell. On `convergence`, settle the cloud's interior flicker into a single bar-locked heartbeat of light — the whole storm glowing and dimming with the band's shared groove — loosening back into scattered pocket strikes as the lock fades, no snap. The sky's own lock-in, sibling to Murmuration's sheet (#146) and Jellyfish Bloom's synchronized pulse (#147). Alive. Area: `presets/Thunderhead.tsx`. Accept: a locked-in groove visibly settles interior flickers into one shared rhythmic glow, then disperses; kick pocket lightning / snare rain shear / hat static / tension towering / dropEvent sky split (#134) and leanIn loom / echo sheet-lightning train (#145) stay distinct.
