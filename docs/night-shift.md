...
- [~] building 2026-08-01T19:00:44Z NS-20260801-07 (S) **Tide Veil leanIn** — The caustic sheet rolls, folds, flashes, and glints echo trains — but meets build-ups flat: on `leanIn`, raise the sheet subtly toward the camera and tighten the caustic folds, water gathering itself for the drop, easing back on release. Alive/beautiful. Area: `presets/TideVeil.tsx`. Accept: a build-up visibly nears the sheet with tightening folds then releases, no snap; swell roll / gather fold / impact flash / afterglow warmth (#30), kit split (#103), echo glint train (#131), and holdBreath hush + tenderness soften (#71) stay distinct.
- [ ] NS-20260801-08 (S) **Ink Bloom leanIn + dropEvent** — The plumes curl, shear, suspend, and ghost-replay — two verified gaps remain, and this closes both: on `leanIn`, coil the plumes tighter and drift them subtly nearer the glass, poised, uncoiling back on release; on `dropEvent`, erupt one full-water ink burst — every plume billowing at once, then settling. Anticipation and payoff for the tank. Alive. Area: `presets/InkBloom.tsx`. Accept: a build-up visibly coils and nears the plumes, and the drop erupts the whole tank once then settles; kick plumes / snare shear / hat motes / gather center / tenderness milk (#87), holdBreath suspension (#102), and echo ghost plumes (#132) stay distinct.
