...
- [~] building 2026-07-23T21:03:00Z NS-20260723-05 (S) **Background holdBreath sky hush** — Engine-wide: during `holdBreath` / deep `silence`, ease nebula/aurora drift speed and dim sky glitter so every backdrop holds still and listens, thawing on the music's return. Alive across all presets with a backdrop. Area: `BackgroundLayer.tsx`. Accept: a quiet held bar visibly stills the sky then it resumes; gather inhale (#24), afterglow warmth (#45), and leanIn pull + vocal warmth (#65) stay distinct.
- [ ] NS-20260723-06 (S) **Night Bloom kit accents** — The petals open on swell, inhale on gather, flare on impact, and mote-glitter on hats, but kick and snare pass silently; wire kick as a radial petal pulse and snare as a lateral petal shear so drums speak through the flower. Alive. Area: `presets/NightBloom.tsx`. Accept: kick/snare/hat each produce a distinct petal accent; swell open + gather inhale + impact flare from #76 stay intact.
