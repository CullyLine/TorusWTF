...
- [~] building 2026-07-16T22:01:20Z NS-20260716-07 (M) **Volumetric Waveform phrase echo** — Ribbon pinches toward the axis on `gather`, blooms on impact, and in post-phrase silence spawns a faded delayed crest from `echo` so the waveform answers the music. Minimal form, deeper life. Area: `presets/VolumetricWaveform.tsx`. Accept: pre-beat pinch; after a vocal phrase gap, a ghost crest travels the ribbon once.
