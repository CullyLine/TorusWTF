...
- [~] building 2026-07-24T23:21:16Z NS-20260725-02 (S) **Rainforest Reverie tenderness misty hush** — The flagship answers the full kit, gather, holdBreath, release, and echo, but it never goes gentle; on `tenderness`, ease canopy sway and lay a warm soft-mist veil over the light so tender vocal passages gentle the forest while it keeps breathing. Alive/beautiful. Area: `presets/RainforestReverie.tsx`. Accept: a tender vocal passage visibly calms and warms the forest and reads different from holdBreath stillness; kick thump, snare gust (#78), hat glitter, and echo fireflies (#85) stay distinct.
