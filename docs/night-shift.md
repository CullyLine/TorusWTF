...
- [~] building 2026-07-24T23:14:34Z NS-20260726-09 (S) **Ember Drift tenderness** — The embers lift, shear, tick, and now hold their breath (#99), but tender passages read the same as loud ones; on `tenderness`, slow the rise, gentle the drift, and warm the glow toward rosy soft coals — a gentling, not a stop, clearly different from the holdBreath freeze. Alive/beautiful. Area: `presets/EmberDrift.tsx`. Accept: a tender vocal passage visibly warms and gentles the ash field and reads different from holdBreath suspension (#99); kick lift, snare shear (#77), and gather/impact/afterglow (#54) stay intact.
