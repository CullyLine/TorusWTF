...
- [~] NS-20260720-05 (S) **Cosmic Mandala vocal rim deepen** — Outer ring + shimmer halo deepen emissive and thicken slightly with `vocalActivity`, while `tenderness` softens rim contrast (pace soften already exists). Beautiful voice-led sacred geometry. Area: `presets/CosmicMandala.tsx`. Accept: vocal-led verse brightens/thickens the outer rim vs instrumental; tender passage softens contrast; kit/gather from #20 unchanged. building 2026-07-20T16:00:42Z
