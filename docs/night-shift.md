...
- [ ] NS-20260804-07 (S) **Tidal Sanctuary tension + convergence** — The ocean cracks, softens, glints, and leans — but never gathers before a storm and never organizes into sets: on `tension`, chop the swell shorter and darker as the build climbs — a storm-sea gathering, spray sharpening; on `convergence`, organize the swell into rhythmic wave sets — crests aligning into bar-locked rolling trains (real oceans arrive in sets), softly scattering back as the lock fades. Alive/beautiful. Area: `presets/TidalSanctuary.tsx`. Accept: a build visibly chops and darkens the sea then releases, and a locked-in groove visibly aligns the crests into rolling sets that scatter on release; snare whitecap crack (#79), tenderness pearlescent sheen (#86), echo moonlit glint train (#98), and leanIn swell raise + approach (#149) stay distinct.
