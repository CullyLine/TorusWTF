...
- [~] NS-20260721-09 (S) **Halo Rain phrase-echo reverse rain** — On `echo`, fire a one-shot upward rain reverse / ring after-image in phrase gaps so the halos answer when the music opens space. Alive call-response. Area: `presets/HaloRain.tsx`. Accept: gap after a phrase shows one reverse-rain reply; while drums speak, no echo reply; gather inhale + impact flare + hat ticks from #44 stay distinct. building 2026-07-21T21:04:00.000Z
