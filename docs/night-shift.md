...
- [ ] NS-20260801-07 (S) **Tide Veil leanIn** — The caustic sheet rolls, folds, flashes, and glints echo trains — but meets build-ups flat: on `leanIn`, raise the sheet subtly toward the camera and tighten the caustic folds, water gathering itself for the drop, easing back on release. Alive/beautiful. Area: `presets/TideVeil.tsx`. Accept: a build-up visibly nears the sheet with tightening folds then releases, no snap; swell roll / gather fold / impact flash / afterglow warmth (#30), kit split (#103), echo glint train (#131), and holdBreath hush + tenderness soften (#71) stay distinct.
