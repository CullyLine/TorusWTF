...
- [ ] NS-20260724-01 (S) **Living palette leanIn cool anticipation** — Engine-wide: on `leanIn`, tilt the palette slightly cool and tighten saturation (the held-breath-before-the-drop look), releasing into the existing drop/impact warm bloom. Beautiful across every preset. Area: `livingPalette.tsx`. Accept: pre-drop passages read visibly cooler, then the drop warms as before; gather cool (#38), holdBreath hush (#57), and mood warmth (#19) stay distinct.
