...
- [x] NS-20260722-05 (S) **Ember Drift kit accents** — Rising ash currently answers gather/impact/afterglow/hat only; wire kick upward lift punch and snare lateral ash shear so drums speak through the field (hat ticks stay). Alive. Area: `presets/EmberDrift.tsx`. Accept: kick/snare/hat each produce a distinct ash accent; gather inhale + impact flare + afterglow from #54 stay intact. — PR #77
