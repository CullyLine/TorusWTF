...
- [~] building 2026-07-30T16:02:15Z NS-20260730-05 (S) **Infinite Tunnel leanIn** — The tunnel punches the kit, freezes on holdBreath, echoes, softens on tenderness, and keeps afterglow heat — but blows through build-ups flat: on `leanIn`, draw the view subtly deeper into the tunnel and narrow the walls, coiled and expectant, releasing back after the drop. Alive. Area: `presets/InfiniteTunnel.tsx`. Accept: a build-up visibly pulls the view deeper and tighter, then releases, no snap; kit accents (#34), holdBreath freeze (#60), echo, and tenderness ease + afterglow heat (#129) stay distinct.
